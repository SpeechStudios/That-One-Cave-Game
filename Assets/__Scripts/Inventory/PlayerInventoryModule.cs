...
public class PlayerInventoryModule : NetworkBehaviour
{
    ...
    public void ClientInit()
    {
        ...
        PlayerUI.UI_Inventory.Bind(this);
        PlayerUI.UI_Inventory.SpawnSlots(this, false);
    }
    public void ServerInit()
    {
        PlayerUIManager.Instance.UI_Inventory.SpawnSlots(this, true);
    }
    [ServerRpc]
    ...
    public void Open()
    {
        PlayerUI.UI_DragGhost.ReturnToSender(); 
    }
    public void Close()
    {
        PlayerUI.UI_DragGhost.ReturnToSender();
    ...
    private LocalResponse LocalInstantEquip(List<InventorySlotData> slots, int from, NetworkConnection conn = default)
    {
        ...
        if (!isClient)
        {
            ...
            Loadout.EquipItem(item, slots[EquipSlot].Type, slots[from].Data.Materials, conn);
        }
